function exportToCSV() {
    var filename = 'coordinadores.csv';  // Reemplaza con el nombre de archivo CSV que deseas descargar
  ...
  function exportToExcel() {
    var filename = 'coordinadores.xlsx';
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    $boton.addEventListener("click", () => {
      ...
      const columnasDeseadas = ["Nombre", "Apellido Paterno", "Apellido Materno", "Telefono oficina", "Celular", "Correo Electronico", "Nombre del Suplente", "Numero de Celular del suplente","Fotografia"];
