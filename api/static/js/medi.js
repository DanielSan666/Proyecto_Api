function exportToCSV() {
    var filename = 'Medicos.csv';  // Reemplaza con el nombre de archivo CSV que deseas descargar
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    $boton.addEventListener("click", () => {
      ...
      const columnasDeseadas = ["Nombre", "Apellido Paterno", "Apellido Materno", "Cedula Profesional","Correo Electronico", "Celular", "Fotografia"];
