function exportToCSV() {
    var filename = 'entrenadores.csv';  // Reemplaza con el nombre de archivo CSV que deseas descargar
  ...
  function exportToExcel() {
    var filename = 'entrenadores.xlsx';
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    $boton.addEventListener("click", () => {
      ...
      const columnasDeseadas = ["Nombre", "Apellido Paterno", "Apellido Materno", "Telefono Oficina", "Celular", "Disciplina", "Rama", "Fotografia"];
