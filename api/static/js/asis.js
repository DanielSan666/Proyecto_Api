function exportToCSV() {
    var filename = 'Asistentes.csv';  // Reemplaza con el nombre de archivo CSV que deseas descargar
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    $boton.addEventListener("click", () => {
      ...
      const columnasDeseadas = ["Nombre", "Apellido Paterno", "Apellido Materno", "Disciplina", "Fotografia"];
      ...
      const columnasOcultas = $elementoParaConvertir.querySelectorAll("th:not(:first-child):not(:nth-child(2)):not(:nth-child(3)):not(:nth-child(4)):not(:nth-child(5)):not(:nth-child(6)):not(:nth-child(7)):not(:nth-child(8)):not(:nth-child(9)):not(:nth-child(10)):not(:nth-child(11)):not(:nth-child(12)), td:not(:first-child):not(:nth-child(2)):not(:nth-child(3)):not(:nth-child(4)):not(:nth-child(5)):not(:nth-child(6)):not(:nth-child(7)):not(:nth-child(8)):not(:nth-child(9)):not(:nth-child(10)):not(:nth-child(11)):not(:nth-child(12))");
